...
export const MOOD_BOARD: MoodBoardItem[] = [
  ...
  { id: '1', title: 'Minimalism', imageUrl: 'https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85?q=80&w=800', tags: ['Clean', 'Light', 'Space'], description: 'A study of negative space and how it defines boundaries without physical barriers.', orientation: 'landscape' },
  ...
  // ── 6–10: Nature & Texture ──
  { id: '6', title: 'Moss Garden', imageUrl: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?q=80&w=800', tags: ['Moss', 'Zen', 'Texture'], description: 'The quiet persistence of green growth on ancient stone.', orientation: 'portrait' },
  ...
  { id: '16', title: 'Ceramic Bowl', imageUrl: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?q=80&w=800', tags: ['Ceramic', 'Craft', 'Form'], description: 'Imperfection as intention in handmade vessels.', orientation: 'portrait' },
  ...
  // ── 21–25: Light & Shadow ──
  { id: '21', title: 'Window Light', imageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=800', tags: ['Light', 'Window', 'Interior'], description: 'Sunlight as the first design material.', orientation: 'landscape' },
  { id: '22', title: 'Shadow Play', imageUrl: 'https://images.unsplash.com/photo-1507400492013-162706c8c05e?q=80&w=800', tags: ['Shadow', 'Contrast', 'Drama'], description: 'Absence of light defines form more than presence.', orientation: 'portrait' },
