...
const SpacialMusic = () => {
  return (
    <WritingLayout
      title="Spatial Album Art: What I Explored and Why I Shelved It"
    ...
    >
      <div className="mb-8">
        <p className="text-xl leading-relaxed mb-6 font-serif text-charcoal/90">
      ...
      <div className="mb-12 space-y-6 text-lg text-charcoal/70 leading-relaxed font-serif">
        <p>
        ...
        <p>
          The core mechanic of the experience is automated subject extraction. Vision's <code className="bg-charcoal/5 px-1.5 py-0.5 rounded text-sm font-mono">VNGenerateForegroundInstanceMaskRequest</code> analyzes the album cover, pulls the foreground subject off the background, and renders them on separate planes. This works well on photographic covers. On illustrated or abstract art, the results range from imperfect to wrong. I planned fallbacks for that, including hand-made PNGs and single-plane rendering when extraction failed.
        </p>
        <p>
